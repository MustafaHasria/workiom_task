...
import 'package:workiom_task/gen/fonts.gen.dart';
import 'app_colors.dart';

ThemeData appTheme(BuildContext context) {
  //? Using Rubik font for the entire app
  const fontFamily = FontFamily.rubik;

  return ThemeData(
    useMaterial3: true, //* Using Material 3 design system
    fontFamily: fontFamily, //* Rubik font for all text
    ...
    scaffoldBackgroundColor: AppColors.surface, //* Default scaffold background color
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w500, fontFamily: fontFamily),
    ),
  );
}
